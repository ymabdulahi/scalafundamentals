...
object Monads extends App {
  ...
  /*
  A monad is a design pattern used to handle computations in a functional way. It allows you to chain operations
  together, handling values and computations in a consistent manner. Monads help manage side effects
  (e.g., handling nulls, logging, state, etc.) without leaving the functional programming paradigm.
   */
