...
object TypeClasses extends App {
  ...
  object TotalEquality extends Equality[User] {
  ...
  object HTMLSerializer {
    ...
    def apply[T](implicit serializer: HTMLSerializer[T]) = serializer // by having an apply method it lets the compiler
    // retrieve the specific serializer you need. and when you do HTMLSerializer[...].serialize(...) it gives access to the entire type class objects
  }
